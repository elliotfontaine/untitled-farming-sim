...
@onready var grid_container := $SlotsRect/SlotsGrid
@onready var buy_label := $ShopRect/BuyButton/Label
@onready var sell_label := $ShopRect/SellButton/Label
